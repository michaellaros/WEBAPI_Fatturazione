...
namespace FatturazioneAPI.Models
{
    public class IVAModel
    {
        ...
        public IVAModel(string ivaGroup, decimal ivaPercent, decimal articlePrice, decimal ivaPrice, int groupId, string szTaxAuthorityID, string szTaxAuthorityName, decimal dIncludedExactTaxValue, decimal dTotalSale, decimal dUsedTotalSale)
        {
